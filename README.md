...
The files consist in LLM-generated task-oriented dialogues in italian, based on human references from the D-Pro Corpus. The synthetic dialogues have been automatically annotated for the presence of _proactivity_.
